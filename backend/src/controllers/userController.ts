...
export const signIn = async (req: Request, res: Response) => {
  try {
    ...
    //  const token = jwt.sign({ userId: user.ID, role:user.role}, "SECRET_KEY", { expiresIn: '5h' });
...
//     // {where: { UBID: UBID }}
//     console.log("borrowed book",userBooks)
...
export const viewBorrowedBooks = async (req: Request, res: Response) => {
  try {
    ...
    console.log("Borrowed books:", userBooks);
